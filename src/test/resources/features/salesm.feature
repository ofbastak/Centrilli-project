...
Feature: Centrilli app login functionality
  User Story :As a user I should be able to login to account with valid salesmanager credentials.

  Scenario Template: User should be able to login with valid salesmanager credentials
    ...
    Examples:
      ...
      | salesmanager47info.com   | salesmanager |
      ...
      | salesmanager101info.com  | salesmanager |
